...
zstyle ':completion:*:*:*:users' ignored-patterns \
    _rpc avahi avahi-autoipd backup bin colord cups-pk-helper daemon dnsmasq \
    games geoclue gitlab-runner gnats hplip irc jicofo jvb kernoops libvirt-dnsmasq \
    libvirt-qemu list lp mail man messagebus mosquitto mpd news nobody postgres \
    prosody proxy pulse rtkit saned sddm sshd sync sys syslog tcpdump timidity tss turnserver \
